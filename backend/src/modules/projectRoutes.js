...
import { createProject, updateProjectStatus,getProject, getAssignTeacher, updateAssignmentProgress } from './projectController.js'
...
router.put("/:id/progress",protect,authorizeRoles("teacher"),updateAssignmentProgress)
